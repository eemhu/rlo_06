...
public final class FullTimeFragmentTest {
    @Test
    void testIdealCaseZOffset() {
        ...
        try (
            ...
            final List<TrackedLease<MemorySegment>> leases = new StringToLease("01:23:34.123456Z", pool).toList();
            ...
            Assertions.assertEquals("01:23:34.123456Z", strBuilder.toString());
    ...
    void testIdealCasePositiveOffset() {
        ...
        try (
            ...
            final List<TrackedLease<MemorySegment>> leases = new StringToLease("01:23:34.123456+02:00", pool).toList();
            ...
            Assertions.assertEquals("01:23:34.123456+02:00", strBuilder.toString());
    ...
    void testFailureCaseUnexpectedCharacter() {
        ...
        try (
            ...
            final List<TrackedLease<MemorySegment>> leases = new StringToLease("01:23:34.12x456Z", pool).toList();
    ...
    void testExcessiveInput() {
        ...
        try (
            ...
            final List<TrackedLease<MemorySegment>> leases = new StringToLease("01:23:34.123456ZZZZZ", pool).toList();
