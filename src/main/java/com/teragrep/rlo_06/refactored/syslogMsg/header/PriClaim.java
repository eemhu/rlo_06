...
public final class PriClaim implements Claim<List<TrackedLease<MemorySegment>>> {
        ...
        for (int i = 0; i < src.size(); i++) {
            ...
            while (lease.hasNext()) {
                ...
                if (!insideTags && b == '<') {
                    ...
                    // tag done, claim ok?
                    return new ResultImpl<>(ResultName.PRI, new ResettedLeases(src).sliceBetween(fromIndex, i));
                }
